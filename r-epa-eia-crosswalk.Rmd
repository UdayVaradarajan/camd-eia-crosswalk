...
earliest_retirement_year <- 2008 # All units retired before this year are filtered out of the data
...
refresh_CAMD_data <- "Yes" # Input "Yes" here if CAMD data should be downloaded and refreshed, "No" if data has already been downloaded
